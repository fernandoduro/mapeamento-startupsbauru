...
// database user name
$db_user = "b9471dc62bae";

// database password
$db_pass = "88c6eb01d2961f73";

// admin username
$admin_user = "stbauru014";

// admin password
$admin_pass = "6agmlnwy4b";
...
// The <title></title> tag
$title_tag = "http://mapa.startupsbauru.com.br - Mapa da comunidade de startups de Bauru";

// The latitude & longitude to center the initial map
$lat_lng = "-22.3066172,-49.0700837";

// Domain to use for various links
$domain = "http://startupsbauru.com.br";

// Twitter username and default share text
$twitter = array(
  "share_text" => "Vamos colocar as startups de Bauru no mapa:",
  // "username" => "d_bonato"
);

// Short blurb about this site (visible to visitors)
$blurb = "Nossa comunidade de Investidores e Startups de Bauru e Região";
